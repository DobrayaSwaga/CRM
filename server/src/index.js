...
app.get('/api/health', (_req, res) => res.json({ ok: true, name: 'CampusCRM', time: new Date().toISOString() }));
...
const FALLBACK_PAGE = `<!doctype html><html lang="ru"><head><meta charset="utf-8"><title>CampusCRM</title>
...
<body><div class="c"><h1 class="g">CampusCRM</h1><p>API работает ✅, а интерфейс ещё не запущен.</p>
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`✅ CampusCRM API запущен: http://0.0.0.0:${PORT}`);
  setupAutoBackup();
