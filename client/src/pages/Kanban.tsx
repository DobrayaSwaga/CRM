    ...
    <div className="h-full flex flex-col animate-fade-in">
      <PageHeader title="Воронка" subtitle="Перетаскивайте карточки между статусами">
        ...
        {hasPerm('contacts.create') && (
          <button onClick={() => setShowCreate(true)} className="flex items-center gap-1.5 text-xs bg-gradient-to-br from-indigo-500 to-violet-600 on-accent rounded-xl px-3 py-1.5 shadow-lg shadow-indigo-500/25 hover:brightness-110 transition-all">
