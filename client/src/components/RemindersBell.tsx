  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <Bell size={16} />
        {count > 0 && (
          <span className="absolute -top-1.5 -right-1.5 min-w-4 h-4 px-1 rounded-full bg-gradient-to-br from-red-500 to-rose-600 text-white text-[9px] font-bold flex items-center justify-center shadow-lg shadow-red-500/40 animate-pulse">
            {count > 9 ? '9+' : count}
          </span>
        )}
      </button>
